...
def update_screen(end_time: int, loop: object, screen: object) -> None:
...
def victory(screen: object) -> None:
    ...
    effects = [
        ...
        Print(
            ...
            x=screen.width//2 - 40,
            y=screen.height//2 + 3,
            start_frame=5, transparent=True)
    ]
    effects.append(
        Print(
            screen,
            ...
            x=screen.width//2 + 10,
            y=screen.height//2 + 3,
            start_frame=5, transparent=False)
    )
    ...
    effects.append(
        Mirage(
            screen,
            Rainbow(screen, FigletText("Victory", font="banner3")), screen.height // 2 - 17, colour=7)
    )
    effects.append(
        Print(
            screen,
